  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm rounded-2xl border border-border bg-surface p-8">
        <h1 className="mb-1 font-display text-2xl font-bold text-fg">Админ нэвтрэх</h1>
        <p className="mb-6 text-sm text-muted">Номын каталог болон дуудлага худалдааг удирдах.</p>
